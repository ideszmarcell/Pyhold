...
class UIManager :
    ...
    def update_button_states (self ,tower_mode :bool ,upgrade_mode :bool ,wave_running :bool ,continuous :bool ,_has_boss :bool )->None :
        """Update button visual states based on game state."""
        self .towers_btn .active =tower_mode 
        self .upgrade_btn .active =upgrade_mode 
        self .start_wave_btn .active =not wave_running 
        self .select_wave_btn .active =not wave_running 
        self .start_wave_btn .text ="Stop Auto"if continuous else "Start Wave"
